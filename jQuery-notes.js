...
The following is an attribute filter. This targets elements with an attribute in it regardless of the value inside that attribute:
...
NEXT, LOAD SCRIPT RIGHT AFTER THE DOM IS LOADED 
(/to be used if you only need the HTML loaded and dont care if the values are loaded or not/)
...
NEXT, LOAD SCRIPT RIGHT AFTER THE COMPLETE PAGE IS LOADED, VALUES AND ALL 
(/To be used if your scrip relies on working with the values inside yout tags/)
